...
class PatientSessionSerializer(serializers.Serializer):
    ...
    createdAt = serializers.DateTimeField(help_text="When the session was created", default_timezone=tzTBS)
    lastUsedAt = serializers.DateTimeField(help_text="When the session was last used", default_timezone=tzTBS)
...
class LabOrderParameterSerializer(serializers.Serializer):
    ...
    uom_name = serializers.CharField(allow_null=True, required=False)
    uom_name_geo = serializers.CharField(allow_null=True, required=False)
    ...
    updated_at = serializers.DateTimeField(allow_null=True, required=False, default_timezone=tzTBS)
    ...
    material_name = serializers.CharField(allow_null=True, required=False)
    material_name_geo = serializers.CharField(allow_null=True, required=False)
...
class LabOrderDetailSerializer(serializers.Serializer):
    ...
    date_order = serializers.DateTimeField(allow_null=True, required=False, default_timezone=tzTBS)
    ...
    date_done = serializers.DateTimeField(allow_null=True, required=False, default_timezone=tzTBS)
    ...
    create_date = serializers.DateTimeField(allow_null=True, required=False, default_timezone=tzTBS)
    write_date = serializers.DateTimeField(allow_null=True, required=False, default_timezone=tzTBS)
    ...
    meta_keywords = serializers.CharField(allow_null=True, required=False, allow_blank=True, help_text="Flat comma-separated list of parameter name, ka_GE translation, and abbr for SEO metadata")
    pregnancy_week = serializers.CharField(allow_null=True, required=False, allow_blank=True, help_text="Pregnancy week information (if applicable)")
    pregnancy_week_geo = serializers.CharField(allow_null=True, required=False, allow_blank=True, help_text="Pregnancy week information in Georgian (if applicable)")
